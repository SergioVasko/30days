                            ...
                            <div>
                                <button type="button"
                                    ...
                                    <img class="h-8 w-8 rounded-full"
                                         src="https://avatars.githubusercontent.com/u/1774270?v=4&size=64" alt="">
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="md:hidden" id="mobile-menu">
            ...
            <div class="border-t border-gray-700 pb-3 pt-4">
                <div class="flex items-center px-5">
                    <div class="flex-shrink-0">
                        <img class="h-10 w-10 rounded-full" src="https://avatars.githubusercontent.com/u/1774270?v=4&size=64"
                             alt="">
                    </div>
                    <div class="ml-3">
